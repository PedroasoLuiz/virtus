...
export function ContaDrawer({
  ...
  const [aceitaCartao, setAceitaCartao] = useState(conta?.aceitaCartao ?? false);
  ...
  const [taxaParcelado, setTaxaParcelado] = useState(conta?.taxaParcelado ?? null);
  const [prazoCredito, setPrazoCredito] = useState(conta?.prazoCreditoDias ?? null);
      ...
      <Formulario>
        ...
        >
          ...
          */}
          ...
          >
            <CampoBloqueado valor={formatarSemSimbolo(conta?.saldoInicial ?? ZERO)} />
          </Field>
        ...
        */}
        ...
        >
          ...
          >
            <ActiveToggle active={aceitaCartao} onChange={() => setAceitaCartao((a) => !a)} />
          </Field>
          ...
          {aceitaCartao && (
            <>
              ...
              >
                <CampoPercentual valor={taxaParcelado} aoMudar={setTaxaParcelado} />
              </Field>
