...
export function BotaoLateralDoWhatsapp({ recolhida }: { recolhida: boolean }) {
  ...
  return (
    ...
    >
      {/*
        ⚠️ Caixa de 15px, a MESMA do `Icon` do menu, e o glifo transborda dela.

        O balão tem 18 e o ícone de grupo tem 15: encaixados pela própria
        largura, os dois ficariam com centros diferentes e o texto ao lado
        começaria em colunas diferentes. Fixando a caixa no tamanho do menu, o
        centro e a coluna de texto batem, e o que sobra do balão transborda
